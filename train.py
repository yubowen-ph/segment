...
parser.add_argument('--crf', dest='crf', action='store_true')
...
parser.add_argument('--C1', type=float, default=0.2, help='Applies to SGD and Adagrad.')
parser.add_argument('--C2', type=float, default=0.02, help='Applies to SGD and Adagrad.')
